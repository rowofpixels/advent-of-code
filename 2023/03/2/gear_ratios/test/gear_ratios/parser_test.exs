defmodule GearRatios.ParserTest do
  ...
  describe "parse/1" do
    ...
    #   assert GearRatios.Parser.parse("Game 3: 4 red, 5 blue; 6 green, 7 red") == %{
    #            id: 3,
    #            hands: [
    #              %{"red" => 4, "blue" => 5},
    #              %{"green" => 6, "red" => 7}
